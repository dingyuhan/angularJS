app.controller("mainctrl",function($scope)
    {
        $scope.introduce = {name:"丁雨晗",site:"河北省，石家庄",fans:"200",click:"3K",pic:"images/a0.jpg",job:"学生",hobby:"speak english with foreigner"};
        $scope.comment = [
        ...
        $scope.fan = [
        {'name':"张三",'occupation':"设计师，博客",'imageurl':"images/a1.jpg",'intimacy':'99%'},
        {'name':"李四",'occupation':"作家，杂志编辑",'imageurl':"images/a2.jpg",'intimacy':'90%'},
        {'name':"王五",'occupation':"艺术总监，电影剪辑",'imageurl':"images/a3.jpg",'intimacy':'85%'},
        {'name':"赵六",'occupation':"音乐家，运动员",'imageurl':"images/a4.jpg",'intimacy':'80%'}
        ];
